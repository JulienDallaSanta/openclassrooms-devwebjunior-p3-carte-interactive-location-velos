...
var Map = {
    // Api OpenData Toulouse key
    velibApi: 'https://api.jcdecaux.com/vls/v1/stations?contract=Toulouse&apiKey=a7366104be3d22e01e3d5cbefb3f59cd24d8b70c',
    map: null,
    ...
    // mapbox Creation, no countdown on footer, call of the velib API
    init: function () {
        Map.map = new mapboxgl.Map({
            center: [1.440466, 43.605000],
            zoom: 11.8,
            container: 'map',
            style: 'mapbox://styles/juliendallasanta/cjzr0ufgz1cua1clhdefajuw7'
        });
